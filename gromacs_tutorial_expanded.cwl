...
steps:
  step_1_pdb:
    in:
      output_pdb_path: step_1_pdb_output_pdb_path
      config: step_1_pdb_config
  ...
  step_8_grompp:
    in:
      config: step_8_grompp_config
      output_tpr_path: step_8_grompp_output_tpr_path
  ...
  step_10_gmx_energy:
    in:
      config: step_10_gmx_energy_config
      output_xvg_path: step_10_gmx_energy_output_xvg_path
  ...
  step_13_gmx_energy:
    in:
      config: step_13_gmx_energy_config
      output_xvg_path: step_13_gmx_energy_output_xvg_path
  ...
  step_16_gmx_energy:
    in:
      config: step_16_gmx_energy_config
      output_xvg_path: step_16_gmx_energy_output_xvg_path
  ...
  step_19_gmx_rms:
    in:
      config: step_19_gmx_rms_config
      output_xvg_path: step_19_gmx_rms_output_xvg_path
  ...
  step_23_gmx_trjconv_str:
    ...
    - output_str_path
inputs:
  step_1_pdb_output_pdb_path: string
  step_1_pdb_config: string
  step_4_editconf_config: string
  step_6_grompp_config: string
  step_7_genion_config: string
  step_8_grompp_config: string
  step_8_grompp_output_tpr_path: string
  step_10_gmx_energy_config: string
  step_10_gmx_energy_output_xvg_path: string
  step_11_grompp_config: string
  step_13_gmx_energy_config: string
  step_13_gmx_energy_output_xvg_path: string
  step_14_grompp_config: string
