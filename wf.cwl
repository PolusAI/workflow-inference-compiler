...
steps:
  ...
  wf_step_5_prod.yml:
    run: prod.cwl
    in:
      prod_step_1_grompp___config: wf_step_5_prod.yml___prod_step_1_grompp___config
      prod_step_1_grompp___output_tpr_path: wf_step_5_prod.yml___prod_step_1_grompp___output_tpr_path
      prod_step_1_grompp___input_gro_path: wf_step_4_npt.yml/npt_step_2_mdrun___output_gro_path
      prod_step_1_grompp___input_top_zip_path: wf_step_1_setup.yml/setup_step_7_genion___output_top_zip_path
      prod_step_2_mdrun___output_gro_path: wf_step_5_prod.yml___prod_step_2_mdrun___output_gro_path
    out:
  ...
  wf_step_6_gmx_rms:
    in:
      config: wf_step_6_gmx_rms___config
      output_xvg_path: wf_step_6_gmx_rms___output_xvg_path
      input_structure_path: wf_step_5_prod.yml/prod_step_1_grompp___output_tpr_path
      input_traj_path: wf_step_5_prod.yml/prod_step_2_mdrun___output_trr_path
  ...
  wf_step_8_gmx_rgyr:
    in:
      config: wf_step_8_gmx_rgyr___config
      input_structure_path: wf_step_2_min.yml/min_step_1_grompp___output_tpr_path
      input_traj_path: wf_step_5_prod.yml/prod_step_2_mdrun___output_trr_path
  ...
  wf_step_9_gmx_image:
    in:
      config: wf_step_9_gmx_image___config
      input_top_path: wf_step_5_prod.yml/prod_step_1_grompp___output_tpr_path
      input_traj_path: wf_step_5_prod.yml/prod_step_2_mdrun___output_trr_path
    run: biobb/biobb_adapters/cwl/biobb_analysis/gmx_image.cwl
    out:
    - output_traj_path
  wf_step_10_gmx_trjconv_str:
    in:
      config: wf_step_10_gmx_trjconv_str___config
      input_top_path: wf_step_5_prod.yml/prod_step_1_grompp___output_tpr_path
      input_structure_path: wf_step_5_prod.yml/prod_step_2_mdrun___output_gro_path
...
inputs:
  ...
  wf_step_5_prod.yml___prod_step_1_grompp___config: string
  wf_step_5_prod.yml___prod_step_1_grompp___output_tpr_path: string
  wf_step_5_prod.yml___prod_step_2_mdrun___output_gro_path: string
  wf_step_6_gmx_rms___config: string
  wf_step_6_gmx_rms___output_xvg_path: string
  wf_step_7_gmx_rms___config: string
  wf_step_7_gmx_rms___output_xvg_path: string
  wf_step_8_gmx_rgyr___config: string
  wf_step_9_gmx_image___config: string
  wf_step_10_gmx_trjconv_str___config: string
outputs:
  ...
  wf_step_5_prod.yml___prod_step_1_grompp___output_tpr_path:
    type: File
    outputSource: wf_step_5_prod.yml/prod_step_1_grompp___output_tpr_path
  wf_step_5_prod.yml___prod_step_2_mdrun___output_trr_path:
    type: File
    outputSource: wf_step_5_prod.yml/prod_step_2_mdrun___output_trr_path
  wf_step_5_prod.yml___prod_step_2_mdrun___output_gro_path:
    type: File
    outputSource: wf_step_5_prod.yml/prod_step_2_mdrun___output_gro_path
  wf_step_5_prod.yml___prod_step_2_mdrun___output_edr_path:
    type: File
    outputSource: wf_step_5_prod.yml/prod_step_2_mdrun___output_edr_path
  wf_step_5_prod.yml___prod_step_2_mdrun___output_log_path:
    type: File
    outputSource: wf_step_5_prod.yml/prod_step_2_mdrun___output_log_path
  wf_step_5_prod.yml___prod_step_2_mdrun___output_cpt_path:
    type: File
    outputSource: wf_step_5_prod.yml/prod_step_2_mdrun___output_cpt_path
  wf_step_6_gmx_rms___output_xvg_path:
    type: File
    outputSource: wf_step_6_gmx_rms/output_xvg_path
  wf_step_7_gmx_rms___output_xvg_path:
    type: File
    outputSource: wf_step_7_gmx_rms/output_xvg_path
  wf_step_8_gmx_rgyr___output_xvg_path:
    type: File
    outputSource: wf_step_8_gmx_rgyr/output_xvg_path
  wf_step_9_gmx_image___output_traj_path:
    type: File
    outputSource: wf_step_9_gmx_image/output_traj_path
  wf_step_10_gmx_trjconv_str___output_str_path:
    type: File
    outputSource: wf_step_10_gmx_trjconv_str/output_str_path
