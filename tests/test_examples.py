...
def is_isomorphic_with_timeout(gm: isomorphism.GraphMatcher, yml_path_str: str) -> None:
    ...
    assert gm.is_isomorphic() # See top-level comment above!
