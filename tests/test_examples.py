...
def test_examples() -> None:
    ...
    for yml_path_str in yml_paths:
        ...
        yaml_tree_raw = wic.ast.read_AST_from_disk(YamlTree(yml_path_str, root_yaml_tree), yml_paths, tools_cwl)
...
def test_cwl_embedding_independence() -> None:
    ...
    for yml_path_str in yml_paths:
        ...
        Path('autogenerated/').mkdir(parents=True, exist_ok=True)
        yaml_tree_raw = wic.ast.read_AST_from_disk(YamlTree(yml_path_str + '.yml', root_yaml_tree), yml_paths, tools_cwl)
