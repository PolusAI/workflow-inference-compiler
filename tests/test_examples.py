...
def test_examples() -> None:
    ...
    for yml_path in yml_paths:
        ...
        workflow_data = wic.compiler.compile_workflow(args, [], [rootgraph], {}, {}, tools_cwl, True, yml_paths[yml_path], {}, yml_paths, relative_run_path=True)
...
def test_cwl_embedding_independence() -> None:
    ...
    for yml_path in yml_paths:
        ...
        rootgraph.attr(newrank='True')
        is_root = True
        workflow_data = wic.compiler.compile_workflow(args, [], [rootgraph], {}, {}, tools_cwl, is_root, yml_paths[yml_path], {}, yml_paths, relative_run_path=False)
        recursive_data = workflow_data[0]
        ...
        for sub_node_data in node_data_lst:
            (sub_namespaces, sub_yml_path_str, sub_cwl_embedded, sub_yaml_dsl_args, sub_yaml_inputs_, sub_dollar_defs_copy, sub_dollar_calls_copy, sub_rootgraph_) = sub_node_data
            ...
            #print('yml_paths[sub_yml_path_str]', yml_paths[sub_yml_path_str])
            #print('sub_yaml_dsl_args', sub_yaml_dsl_args)
            fake_root = True
            workflow_data_fakeroot = wic.compiler.compile_workflow(args, sub_namespaces, [rootgraph_fakeroot], {}, {}, tools_cwl, fake_root, yml_paths[sub_yml_path_str], sub_yaml_dsl_args, yml_paths, relative_run_path=False)
