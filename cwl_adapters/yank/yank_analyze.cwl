...
stdout: $(inputs.output_stdout_path)
...
outputs:
  ...
  output_stdout_path:
    ...
    streamable: true
    outputBinding:
      glob: $(inputs.output_stdout_path)

# Equilibration and production files should still be present
...
# Trailblazing files should still be present
