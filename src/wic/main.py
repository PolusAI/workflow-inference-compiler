...
from . import utils
from .wic_types import Cwl, Yaml, Tool, Tools, YamlTree, GraphReps
...
def main() -> None:
    ...
    if args.cwl_run_local:
        ...
        cmd = ['cwltool', '--parallel', '--cachedir', 'cachedir','--outdir', 'outdir', f'autogenerated/{yaml_stem}.cwl', f'autogenerated/{yaml_stem}_inputs.yml']
