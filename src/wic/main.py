...
def main() -> None:
    ...
    yaml_tree_raw = ast.read_AST_from_disk((yaml_path, root_yaml_tree), yml_paths, tools_cwl)
    ...
    with rootgraph.subgraph(name=f'cluster_{yaml_path}') as subgraph_gv:
        ...
        workflow_data = compiler.compile_workflow(yaml_tree, args, [], [subgraph], {}, {}, tools_cwl, True, relative_run_path=True)
        recursive_data = workflow_data[0]

    sub_graph_nx = recursive_data[0][-1][1]
    nx.draw(sub_graph_nx)
