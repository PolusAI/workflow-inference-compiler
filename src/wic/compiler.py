    ...
    for i, step_key in enumerate(steps_keys):
        ...
        if step_key in subkeys:
            ...
            if 'python_script' == step_key:
                ...
                module = python_cwl_adapter.get_module(python_script_mod, Path(python_script_path), yml_args)
                generated_cwl = python_cwl_adapter.generate_CWL_CommandLineTool(module.inputs, module.outputs)
