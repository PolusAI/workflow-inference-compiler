...
# from wic.api.utils import converter
...
async def compile_wf(request: Request) -> Json:
    ...
    # yaml_tree_json: Json = converter.wfb_to_wic(req)
    # yaml_tree_json = get_yaml_tree(req)

    workflow_temp = req["templates"]["ict"]["cwlScript"]  # Assume dict form
    workflow_can = utils_cwl.desugar_into_canonical_normal_form(workflow_temp)

    # ========= BUILD WIC COMPILE INPUT =========
    # ict_plugins = req["templates"]
    ...
    compute_workflow.get('retval', str(retval))
